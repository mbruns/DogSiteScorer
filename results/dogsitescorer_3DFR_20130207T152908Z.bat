...
SETVAR $(complex) "tmp/cache/3DFR_20130207T152908Z.pdb"
SETVAR $(result) "descriptor_data_3DFR_20130207T152908Z.txt"
...
SET VERBOSITY 5
 ...
 WRITE_DESC $(result_dir)SpocXls_$(result) 1 1
  WRITE_PDB $(result_dir)poc_reduced_3DFR_20130207T152908Z 50 0 1
  WRITE_PDB $(result_dir)atms_3DFR_20130207T152908Z 50 1
 MAIN
  DELALL
