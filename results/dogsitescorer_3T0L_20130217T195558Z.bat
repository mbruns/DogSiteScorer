...
SETVAR $(complex) "tmp/cache/3T0L_20130217T195558Z.pdb"
SETVAR $(result) "descriptor_data_3T0L_20130217T195558Z.txt"
...
SET VERBOSITY 5
 ...
 WRITE_DESC $(result_dir)SpocXls_$(result) 1 1
  WRITE_PDB $(result_dir)poc_reduced_3T0L_20130217T195558Z 50 0 1
  WRITE_PDB $(result_dir)atms_3T0L_20130217T195558Z 50 1
 MAIN
  DELALL
